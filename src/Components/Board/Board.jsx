    ...
    render(){
        ...
        return (
            <section className='container-fluid'>
                ...
                <div className="row">
                    <div className="col-sm-2"><Timer></Timer></div>
                    
                    <dir className= "col-sm-8">
                            
                        {array.map((value,indx)=>(
                        <div className= {size===BIG_ARRAY_SIZE ? "big-array-bar" : "small-array-bar"} key={indx}
                    ...
                    <div className="col-sm-2"><Information></Information></div>
